...
const GreenRolling = () => {
    ...
    const fetchDryingData = async () => {
        try {
            const res = await axiosInstance.get(endpoints.GreenTea.GreenTeaRoasting);
        ...
        <Box sx={{ padding: { xs: 2, md: 4 } }}>
            <Container maxWidth='xl'>
                ...
                <Breadcrumbs sx={{ mb: 2, fontSize: "15px" }}>
                    ...
                    <Typography color="text.primary" sx={{ fontSize: "15px" }}>Roasting Process (Panning)</Typography>
                </Breadcrumbs>
                            ...
                            {leftMenu.map((item) => (
                                <ListItemButton
                                    ...
                                    sx={{
                                        ...
                                        backgroundColor: item === "ROASTING PROCESS (PANNING)" ? "green" : "transparent",
                                        color: item === "ROASTING PROCESS (PANNING)" ? "#fff" : "#000",
                                        "&:hover": {
                                            backgroundColor: item === "ROASTING PROCESS (PANNING)" ? "green" : "#f5f5f5",
                                        },
                                        fontFamily: "Roboto"
                                    }}
                                >
