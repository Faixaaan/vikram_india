...
//           <Typography color="text.primary" sx={{ fontSize: "15px" }}>Foreign Object Remover Tool</Typography>
//         </Breadcrumbs>
...
//                     backgroundColor: item === "FOREIGN OBJECT REMOVER TOOL" ? "green" : "transparent",
//                     color: item === "FOREIGN OBJECT REMOVER TOOL" ? "#fff" : "#000",
//                     "&:hover": {
//                       backgroundColor: item === "FOREIGN OBJECT REMOVER TOOL" ? "green" : "#f5f5f5",
//                     },
//                     fontFamily: "Roboto"
//                   }}
//                 >
...
const ForeignObject = () => {
  ...
  const fetchForeignObjectData = async () => {
    try {
      const res = await axiosInstance.get(
        endpoints.GardenPlantation.foreign_object_removal
      );
      setData(res?.data?.data);
    } catch (err) {
      console.log(err);
              ...
              {leftMenu.map((item) => (
                <ListItemButton
                  ...
                  sx={{
                    borderBottom: "1px solid #eee",
                    backgroundColor:
                      item === "FOREIGN OBJECT REMOVER TOOL"
                        ? "green"
                        : "transparent",
                    color:
                      item === "FOREIGN OBJECT REMOVER TOOL"
